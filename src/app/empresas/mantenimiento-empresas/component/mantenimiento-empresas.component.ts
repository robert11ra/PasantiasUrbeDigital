...
import { Empresa, Departamento, Sucursal } from '../../empresa';
...
export class MantenimientoEmpresasComponent implements OnInit, AfterViewInit {

 
  @ViewChild(MatPaginator) paginator: MatPaginator;
  
  public empresasList: Empresa[] = this.empresasService.getEmpresas();
  public dptosList: Departamento[];

  dataSource = new MatTableDataSource(this.empresasList);
  isLargeScreen = false;
  displayedColumns: string[] = ['rif', 'pcode','nombre'];
  ...
  refreshData(): void{
    ...
    this.dataSource = new MatTableDataSource(this.empresasList);
  }
}
