...
@Component({
  selector: 'app-mantenimiento-sucursales',
  templateUrl: './mantenimiento-sucursales.component.html',
  styleUrls: ['./mantenimiento-sucursales.component.css']
})
export class MantenimientoSucursalesComponent implements OnInit {
